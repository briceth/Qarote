 ...
 * API Response Types
 *
 * Lean response types containing only fields actually used by the front-end.
...
/**
 * Rate detail with only the rate field (used by front-end)
 */
...
/**
 * Queue API Response - only fields used by front-end
 */
...
/**
 * Overview API Response - only fields used by front-end
 */
...
/**
 * VHost API Response - only fields used by front-end
 */
...
/**
 * Exchange API Response - only fields used by front-end
 */
...
/**
 * User API Response - only fields used by front-end
 */
...
/**
 * Node API Response - only fields used by front-end
 */
