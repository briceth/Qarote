...
/**
 * Versioned webhook API routes
 * Base path: /api/webhooks/v1/workspaces/:workspaceId/webhooks
 */

// GET /api/webhooks/v1/workspaces/:workspaceId/webhooks
...
// GET /api/webhooks/v1/workspaces/:workspaceId/webhooks/:id
...
// POST /api/webhooks/v1/workspaces/:workspaceId/webhooks
...
// PUT /api/webhooks/v1/workspaces/:workspaceId/webhooks/:id
// Update a webhook
...
// DELETE /api/webhooks/v1/workspaces/:workspaceId/webhooks/:id
// Delete a webhook
